...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <form id="dynamic-form" action="{{ route('admin.dynamicForms.update', $dynamicForm->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="form_name" name="form_name"
                                    value="{{ $dynamicForm->form_name }}" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="description">Description</label>
                                <textarea class="form-control" id="description" name="description">{{ $dynamicForm->description }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2 mt-5">
                            <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-primary" id="submit-form">Update</button>
                            </div>
                        </div>
            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <h3>Form Fields</h3>
                        <div id="form-fields-container" class="field-container-group">
                            @foreach ($dynamicForm->dynamicFormFields as $field)
                                @php
                                    $field->formField->type;
                                @endphp
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            formFieldsList.addEventListener('click', function(event) {
                if (event.target.classList.contains('form-field-button')) {
                    ...
                    <input type="hidden" class="hidfield" name="hid_form_fields[${fieldId}][dynamic_frm_field_id]" value="0">
            ...
            form.addEventListener('submit', function(event) {
                ...
                if (document.querySelectorAll('.hidfield').length === 0 && document.querySelectorAll(
                        '.hidfield-edit').length === 0) {
